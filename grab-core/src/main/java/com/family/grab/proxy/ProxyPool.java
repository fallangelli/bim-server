package com.family.grab.proxy;

import com.family.grab.utils.FilePersistentBase;
import com.family.grab.utils.ProxyUtils;
...
public class ProxyPool {
    ...
    private String proxyFilePath = "/data/grab/lastUse.proxy";
    ...
    private void setFilePath() {
        ...
        String path = tmpDir + FilePersistentBase.PATH_SEPERATOR + "grab" + FilePersistentBase.PATH_SEPERATOR + "lastUse.proxy";
        if (tmpDir != null && new File(tmpDir).isDirectory()) {
            fBase.setPath(tmpDir + FilePersistentBase.PATH_SEPERATOR + "grab");
