...
import com.family.grab.selector.Json;
import com.family.grab.selector.Selectable;
 ...
 * {@link #getResultItems()} get extract results to be used in {@link com.family.grab.pipeline.Pipeline}<br>
 * {@link #addTargetRequests(java.util.List)} {@link #addTargetRequest(String)} add urls to fetch                 <br>
 *
 * @author code4crafter@gmail.com <br>
 * @see com.family.grab.downloader.Downloader
 * @see com.family.grab.processor.PageProcessor
 * @since 0.1.0
 */
public class Page {
